        ...
        private void saveGame() {
            ...
            if (file != null) {
                ...
                try (FileWriter fileWriter = new FileWriter(file)) {
                    ...
                    fileWriter.write(this.currentPlayer + "\n");

                    // Write the number of moves for each player
                    fileWriter.write(this.movesPlayer1 + "\n");
                    fileWriter.write(this.movesPlayer2 + "\n");
         ...
         private void loadGame() {
             ...
             if (file != null) {
                 ...
                 try (Scanner scanner = new Scanner(file)) {
                     ...
                     this.movesPlayer1 = scanner.nextInt();
                     this.movesPlayer2 = scanner.nextInt();
